...
markers_list_df <- readRDS(here::here("output/muscat_simulation/results/muscat__DE_markers_list_df_DESeq2.rds"))

seeds <- c(20141015, 20160823, 20210827)
for (seed in seeds) {
  for (test.use in c("DESeq2")) {
...
saveRDS(all_fdr_tpr_df_melt, here::here("output/muscat_simulation/results/all_fdr_tpr_df_melt_DESeq2.rds"))
